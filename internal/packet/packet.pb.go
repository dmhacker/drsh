...
type Packet struct {
	...
	Recipient string            `protobuf:"bytes,3,opt,name=recipient,proto3" json:"recipient,omitempty"` // Unique name of receiving machine
	Payload   []byte            `protobuf:"bytes,4,opt,name=payload,proto3" json:"payload,omitempty"`     // Used by OUTPUT messages
	Nonce     []byte            `protobuf:"bytes,5,opt,name=nonce,proto3" json:"nonce,omitempty"`         // Used by OUTPUT messages
	Key       []byte            `protobuf:"bytes,6,opt,name=key,proto3" json:"key,omitempty"`             // Used by HANDSHAKE messages
	// Client only fields
	PtyRows    uint32 `protobuf:"varint,7,opt,name=pty_rows,json=ptyRows,proto3" json:"pty_rows,omitempty"`
	PtyCols    uint32 `protobuf:"varint,8,opt,name=pty_cols,json=ptyCols,proto3" json:"pty_cols,omitempty"`
	PtyXpixels uint32 `protobuf:"varint,9,opt,name=pty_xpixels,json=ptyXpixels,proto3" json:"pty_xpixels,omitempty"`
	PtyYpixels uint32 `protobuf:"varint,10,opt,name=pty_ypixels,json=ptyYpixels,proto3" json:"pty_ypixels,omitempty"`
	// Server only fields
	PingUptime *duration.Duration `protobuf:"bytes,11,opt,name=ping_uptime,json=pingUptime,proto3" json:"ping_uptime,omitempty"`
}
...
func (x *Packet) GetRecipient() string {
	if x != nil {
		return x.Recipient
	}
	return ""
...
var file_proto_packet_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x04, 0x0a,
	...
	,
