...
const (
	...
	SessionMessage_HEARTBEAT_CLIENT     SessionMessage_MessageType = 1 // C->S, empty message to signal that client is still active
	SessionMessage_HEARTBEAT_SERVER     SessionMessage_MessageType = 2 // S->C, empty message to signal that server is still active
	SessionMessage_PTY_INPUT            SessionMessage_MessageType = 3 // C->S, client is sending commands to the server's PTY
	SessionMessage_PTY_WINCH            SessionMessage_MessageType = 4 // C->S, client wants to adjust the size of the server's PTY
	SessionMessage_PTY_OUTPUT           SessionMessage_MessageType = 5 // S->C, server is sending output from its PTY
	SessionMessage_FILE_TRANSFER        SessionMessage_MessageType = 6 // S->C, C->S, the party sending a file uses this message to transfer data
	SessionMessage_FILE_TRANSFER_FINISH SessionMessage_MessageType = 7 // S->C, C->S, the party sending a file indicates that they are done
)
...
type PublicMessage struct {
	...
	SessionUser     string      `protobuf:"bytes,5,opt,name=session_user,json=sessionUser,proto3" json:"session_user,omitempty"`                              // Client requests that the session be tied to this user account
	SessionFilename string      `protobuf:"bytes,6,opt,name=session_filename,json=sessionFilename,proto3" json:"session_filename,omitempty"`                  // Client requests that the session prepare this remote file for transfer
	...
	SessionMotd     string      `protobuf:"bytes,10,opt,name=session_motd,json=sessionMotd,proto3" json:"session_motd,omitempty"`                             // Server provides a MOTD to be displayed to the client
}
...
func (x *PublicMessage) GetSessionUser() string {
	if x != nil {
...
func (x *PublicMessage) GetSessionFilename() string {
	if x != nil {
		return x.SessionFilename
	}
	return ""
}
...
func (x *PublicMessage) GetSessionMotd() string {
	if x != nil {
		return x.SessionMotd
	}
	return ""
}
...
var file_internal_drsh_proto_message_proto_rawDesc = []byte{
	...
	0x90, 0x04, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	,
	...
	,
	...
	,
