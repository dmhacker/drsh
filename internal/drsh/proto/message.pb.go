...
const (
	...
	SessionMessage_PARAM_REQUEST        SessionMessage_MessageType = 1 // C->S, client starts by requesting that the session follow these parameters
	SessionMessage_PARAM_RESPONSE       SessionMessage_MessageType = 2 // S->C, server acknowledges that it will respect the client's wishes
	SessionMessage_HEARTBEAT_CLIENT     SessionMessage_MessageType = 3 // C->S, empty message to signal that client is still active
	SessionMessage_HEARTBEAT_SERVER     SessionMessage_MessageType = 4 // S->C, empty message to signal that server is still active
	...
	SessionMessage_FILE_TRANSFER        SessionMessage_MessageType = 8 // S->C, C->S, the party sending a file uses this message to transfer data
	SessionMessage_FILE_TRANSFER_FINISH SessionMessage_MessageType = 9 // S->C, C->S, the party sending a file indicates that they are done
)
...
type SessionMessage struct {
	...
	// Parameter messages
	ParamMode     SessionMode `protobuf:"varint,5,opt,name=param_mode,json=paramMode,proto3,enum=drsh.proto.SessionMode" json:"param_mode,omitempty"` // Client requests that the session be of this mode
	ParamUsername string      `protobuf:"bytes,6,opt,name=param_username,json=paramUsername,proto3" json:"param_username,omitempty"`                  // Client requests that the session be tied to this user account
	ParamFilename string      `protobuf:"bytes,7,opt,name=param_filename,json=paramFilename,proto3" json:"param_filename,omitempty"`                  // Client requests that the session prepare this remote file for transfer
	ParamMotd     string      `protobuf:"bytes,8,opt,name=param_motd,json=paramMotd,proto3" json:"param_motd,omitempty"`                              // Server provides a MOTD to be displayed to the client
	// PTY messages
	...
	// File messages
	FilePayload []byte `protobuf:"bytes,11,opt,name=file_payload,json=filePayload,proto3" json:"file_payload,omitempty"` // used by FILE_TRANSFER message
}
...
func (x *SessionMessage) GetParamMode() SessionMode {
	if x != nil {
		return x.ParamMode
	}
...
func (x *SessionMessage) GetParamUsername() string {
	if x != nil {
		return x.ParamUsername
	}
	return ""
}

func (x *SessionMessage) GetParamFilename() string {
	if x != nil {
		return x.ParamFilename
	}
	return ""
}

func (x *SessionMessage) GetParamMotd() string {
	if x != nil {
		return x.ParamMotd
	}
	return ""
...
var file_internal_drsh_proto_message_proto_rawDesc = []byte{
	...
	0x04, 0x22, 0xfc, 0x04, 0x0a, 0x0e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73,
	...
	,
	...
	,
	...
	,
...
var file_internal_drsh_proto_message_proto_depIdxs = []int32{
	...
	0, // 2: drsh.proto.SessionMessage.param_mode:type_name -> drsh.proto.SessionMode
